# TikTokPartnerSdk Documentation

This documentation follows the same structure as `ShopeeSdk`: short task-focused pages, stable package names, and links to generated API categories.
