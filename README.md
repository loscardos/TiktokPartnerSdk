...
> Status: `0.1.2-preview`. The package is ready for sandbox validation and early integration work. Review behavior against your own TikTok app permissions before live rollout.
