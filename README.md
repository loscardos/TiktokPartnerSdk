...
Status: `0.1.0-preview`. The SDK is ready for local package smoke testing and starter sandbox integration work. It now has typed API errors, transient retry support, optional in-memory rate limiting, generated endpoint coverage for Authorization, Seller, Event, Orders, Products, Fulfillment, and Logistics, and a YAML documentation normalization path. Full production coverage is still in progress.
